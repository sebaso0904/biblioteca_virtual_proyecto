...
// -------------------- factory aplicado en SistemaLogin --------------------
...
public:
    // Método fábrica
    static SistemaLogin* crearSistemaLogin(const string& archivo = "usuarios.txt") {
        return new SistemaLogin(archivo);
    }
...
// -------------------- main --------------------
int main() {
    SistemaLogin* sistema = SistemaLogin::crearSistemaLogin("usuarios.txt");
    int opcion;
